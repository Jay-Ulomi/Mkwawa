                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-image es-p20b" style="font-size:0px">
                                              <a target="_blank">
                                                <img src="https://eigrrkb.stripocdn.email/content/guids/CABINET_f6fdeea6c02c0d03f5f8de7709bfdaefbec9f375397f41408c4981381a682561/images/asset84x.png" alt="Logo" width="200" title="Logo" class="adapt-img" style="display: block; font-size: 12px">
                                              </a>
                                            </td>
                                          </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td align="left" class="esd-block-text es-p5t es-p5b">
                                              ...
                                              <h1 style="font-size:16px;line-height:100%">
                                                <b>
                                              ...
                                              {{-- <p>
                                                We will really appreciate it if you find 30 minutes to meet us. As a thank you, we will send you any piece of clothing&nbsp;of your choice&nbsp;from our collection.
                                              </p> --}}
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="left" class="esd-block-text es-p5t es-p5b">
                                              <p>
                                                Best regards,
                                                <br>
                                                Mkwawa Leaf Tobacco Limited Team.
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                                  ...
                                                  <tr>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="Facebook" src="https://eigrrkb.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="X" src="https://eigrrkb.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png" alt="X" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="Instagram" src="https://eigrrkb.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top">
                                                      <a target="_blank" href="">
                                                        <img title="Youtube" src="https://eigrrkb.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32">
                                                      </a>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-p35b">
                                              <p>
                                                Mkwawa Leaf Tobacco Limited© 202. All Rights Reserved.
                                              </p>
                                              <p>
                                                Morogoro, Tanzania Ujenzi road Tanzania
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
